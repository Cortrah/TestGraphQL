...
class TurnsControllerTest < ActionController::TestCase
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post :create, turn: { introduction: @turn.introduction, number: @turn.number, results: @turn.results }
    end
  ...
  test "should update turn" do
    patch :update, id: @turn, turn: { introduction: @turn.introduction, number: @turn.number, results: @turn.results }
    assert_redirected_to turn_path(assigns(:turn))
  end
